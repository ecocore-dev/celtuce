...
(extend-type RedisCommands
  ...
  (hlen [this k]
    (.hlen this k))
  (hmget [this k fs]
    (->> (.hmget this k ^objects (into-array Object fs))
  ...
  KeyCommands
  (del [this k]
    (.del this ^objects (into-array Object [k])))
  (dump [this k]
    (.dump this k))
  (exists [this k]
  ...
  (mdel [this ks]
    (.del this ^objects (into-array Object ks)))
  (mexists [this ks]
  ...
  (move [this k ^Integer db]
    (.move this k db))
  (mtouch [this ks]
    (.touch this ^objects (into-array Object ks)))
  (munlink [this ks]
    (.unlink this ^objects (into-array Object ks)))
  (obj-encoding [this k]
  ...
  (touch [this k]
    (.touch this ^objects (into-array Object [k])))
  (ttl [this k]
    (.ttl this k))
  (type [this k]
    (.type this k))
  (unlink [this k]
    (.unlink this ^objects (into-array Object [k])))
  ...
  (mget [this ks]
    (->> (.mget this ^objects (into-array Object ks))
         (map (fn [^KeyValue kv] (.getValueOrElse kv nil)))
         (into (empty ks))))
  (mset [this ^Map m]
    (.mset this m))
  ...
  (lpushx [this k v]
    (.lpushx this k ^objects (into-array Object [v])))
  ...
  (mrpushx [this k vs]
    (.rpushx this k ^objects (into-array Object vs)))
  (mlpush [this k vs]
    (.lpush this k ^objects (into-array Object vs)))
  (mlpushx [this k vs]
    (.lpushx this k ^objects (into-array Object vs)))
  (rpop [this k]
    (.rpop this k))
  (rpoplpush [this s d]
    (.rpoplpush this s d))
  ...
  (rpushx [this k v]
    (.rpushx this k ^objects (into-array Object [v])))
  ...
  (geohash [this key member]
    (->> ^objects (into-array Object [member])
         (.geohash this key)
         ^Value (first)
         (.getValue)))
  (mgeohash [this key members]
    (->> ^objects (into-array Object members)
         (.geohash this key)
